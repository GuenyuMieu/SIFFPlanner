...
> 一个帮助影迷规划电影节观影行程的 Web 工具，支持上海国际电影节排片表。以后只要上影节的排片excel格式不变，就可以一直使用。(有尝试过兼容北影节，但北影节的排片表不带时长，不太能适用该网页)
